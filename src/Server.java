...
public class Server implements ActionListener
{
    ...
    Server()
    {
        ...
        //SETTING PROFILE PICTURE OF SERVER
        //get image from local disk
        ImageIcon serverIconIntermediate = new ImageIcon(ClassLoader.getSystemResource("chatApplicationIcons/serverIcon.png"));
        //set size of image icon
        Image serverIconSize = serverIconIntermediate.getImage().getScaledInstance(60, 60, Image.SCALE_DEFAULT);
        ImageIcon serverIcon = new ImageIcon(serverIconSize);
        //set image in label
        JLabel serverIconLabel = new JLabel(serverIcon);
        //create custom layout
        serverIconLabel.setBounds(20, 5, 60, 60);
        //add element on frame
        header.add(serverIconLabel);
        //mouse click to view profile picture
        serverIconLabel.addMouseListener(new MouseAdapter()
        {
            @Override
            public void mouseClicked(MouseEvent e)
            {
                //set frame to view profile picture
                JFrame pfpFrame = new JFrame("Server Profile Picture");
                //set size of pfpFrame
                pfpFrame.setSize(350, 350);
                //get image from local disk
                ImageIcon serverIconIntermediate = new ImageIcon(ClassLoader.getSystemResource("chatApplicationIcons/serverIcon.png"));
                //set size of image icon
                Image serverIconSize = serverIconIntermediate.getImage().getScaledInstance(300, 300, Image.SCALE_DEFAULT);
                //set set rescaled icon to new icon
                ImageIcon serverIcon = new ImageIcon(serverIconSize);
                //set pfpIcon to pfpLabel
                JLabel pfpLabel = new JLabel(serverIcon);
                //set pfpLabel size
        ...
        //text to speech conversion when icon is clicked
        ...
        //start voice recording when icon is clicked
        ...
        //set size of chat window
        chatWindow.setSize(450, 700);
        //set location on screen
        chatWindow.setLocation(250, 100);
    ...
    public void  actionPerformed(ActionEvent ae)
    {
        try
        {
            ...
            //messageBackground.setBackground(Color.WHITE);
            ...
            typeArea.setText("");
            //messageSpace.add(messageBackground);
    ...
    public static void showFilesServer() throws IOException, ClassNotFoundException
    {
        //accept request and create socket to establish communication
    ...
    {
        //creating object
        new Server().chatWindow.setVisible(true);
        //String to hold messages coming in

        String messageInput = "";

        //create server socket and set port number
